...
{
  $ongoing_query = "SELECT * from dentalmarcelo_user where id=:user_id and token=:token";
 ...
 if($num_token > 0)
    {
      $parent['token']='yes';
     $sel_user_query1 = "SELECT * FROM dentalmarcelo_user WHERE id = :id AND password=:password";
    ...
    if($num_rows>0){
      ...
      $sel_user_query1 = "Update dentalmarcelo_user set password=:password WHERE id = :id";
 ...
 if($num_token > 0)
    {
    $parent['token']='yes';
    $ongoing_query = "Update `dentalmarcelo_user` set `profile_pic`=:profile_pic,`total_coverage`=:total_coverage,`phone`=:phone,`fullname`=:fullname where  `id`=:id";
 ...
 if($num_token > 0)
    {
$parent['token']='yes';
  $ongoing_query = "SELECT * from dentalmarcelo_review where provider_id=:provider_id and approve=1 order by id desc";
    ...
    if($num_rows > 0)
    {
      ...
      $ongoing_query1 = "SELECT avg(`rating`) as `rating` from dentalmarcelo_review where  provider_id=:provider_id and approve=1";
...
$ongoing_query1 = "SELECT * from dentalmarcelo_review where  provider_id=:provider_id and rating>1 and rating<2 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dentalmarcelo_review where  provider_id=:provider_id and rating>2 and rating<3 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dentalmarcelo_review where  provider_id=:provider_id and rating>3 and rating<4 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dentalmarcelo_review where  provider_id=:provider_id and rating>4 and rating<5 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dentalmarcelo_review where  provider_id=:provider_id and rating=5 and approve=1";
         ...
         foreach($results as $result)
        {
          ...
          $ongoing_query1 = "SELECT * from dentalmarcelo_user where  id=:id order by id";
 ...
 if($num_token > 0)
    {
	$parent['token']='yes';
	$ongoing_query = "SELECT * from dentalmarcelo_review where provider_id=:provider_id and user_id=:user_id";
    ...
    {
	  $ongoing_query = "Insert into `dentalmarcelo_review` set `provider_id`=:provider_id,`rating`=:rating,review=:review,user_id=:user_id";
...
else
{
 ...
 if($num_token > 0)
  ...
  $parent['token']='yes';
    $ongoing_query = "Insert into `dentalmarcelo_referral` set `email`=:email,`message`=:message,name=:name,user_id=:user_id";
 ...
 else
 {
  $parent['token']='no';
	...
	$answer = implode(',',json_decode($event_encoded["answer_id"]));
	  $ongoing_query = "Insert into `dentalmarcelo_questionnaire` set `cat_id`=:cat_id,`question_id`=:question_id,answer=:answer,user_id=:user_id";
...
mail($to,$subject,$body,$headers);*/
 ...
 if($num_token > 0)
    {
$parent['token']='yes';
              $ongoing_query = "Insert into `dentalmarcelo_checkin_status` set `appointment_id`=:appointment_id,`checkin_status`=:checkin_status,checkin_note=:checkin_note";
...
$parent['token']='yes';
    ...
    $ongoing_query = "Insert into `dentalmarcelo_chat` set `message`=:message,user_id=0,dt=:dt,from_user=:user_id";
 ...
 if($num_token > 0)
    {
      $parent['token']='yes';
$ongoing_query = "SELECT * from dentalmarcelo_insurance where  user_id=:user_id";
       ...
       $statement = $pdo->prepare($ongoing_query);
        ...
        $statement->execute(array( "user_id" =>$event_encoded['user_id']
         ...
         if($num_rows>0)
         {
              ...
              $ongoing_query = "Update `dentalmarcelo_insurance` set `insurance_id`=:insurance_id,`dental_amount`=:dental_amount,vision_amount=:vision_amount,total_coverage=:total_coverage where user_id=:user_id";
        ...
        $statement->execute(array(
            ...
            {
               $ongoing_query = "Insert into `dentalmarcelo_insurance` set `insurance_id`=:insurance_id,`dental_amount`=:dental_amount,vision_amount=:vision_amount,user_id=:user_id,total_coverage=:total_coverage";
  ...
  $ongoing_query = "SELECT * from dentalmarcelo_notification where notification_type=:notification_type";
    ...
    {
       $parent['status']='yes';
        $ongoing_query ="Insert into `dentalmarcelo_notification` set `user_id`=:user_id,notification_date=:notification_date,notification_type=:notification_type,message=:message,notification_attr=:status";
...
"notification_type"=>$event_encoded["notification_type"]
 ...
 if($num_token > 0)
    {
      $parent['token']='yes';
  $ongoing_query = "SELECT * from dentalmarcelo_notification where user_id=:user_id order by id desc";
 ...
 if($num_token > 0)
    {
$parent['token']='yes';
  $ongoing_query = "SELECT * from dentalmarcelo_gallery order by id desc";
...
{
  $ongoing_query = "SELECT * from dentalmarcelo_appointment where (status='approved' or status='In Progress') and user_id=:user_id order by id";
}
if($event_encoded["type"]=='cancelled')
{
  $ongoing_query = "SELECT * from dentalmarcelo_appointment where status='cancelled' and user_id=:user_id order by id";
}
if($event_encoded["type"]=='completed')
{
  $ongoing_query = "SELECT * from dentalmarcelo_appointment where status='completed' and user_id=:user_id order by id";
}
    ...
    if($num_rows > 0)
    {
        ...
        $i=0;
         foreach($results as $result)
        {
          $ongoing_query1 = "SELECT * from dentalmarcelo_provider where  id=:id order by id";
        ...
        $ongoing_query1 = "SELECT * from dentalmarcelo_patient_acknowledge_form where  user_id=:id";
        ...
        $ongoing_query1 = "SELECT * from dentalmarcelo_patient_screening_form where  appointment_id=:id";
        ...
        $ongoing_query1 = "SELECT * from dentalmarcelo_history_form where  appointment_id=:id";
 ...
 if($num_token > 0)
  ...
  $ongoing_query = "SELECT * from dentalmarcelo_insurance where user_id=:user_id order by id";
    ...
    if($num_rows > 0)
    {
        ...
        $i=0;
         foreach($results as $result)
        {
           /*$ongoing_query1 = "SELECT * from dentalmarcelo_insurance_provider where  id=:id order by id";
 ...
 if($num_token > 0)
    {
$parent['token']='yes';
  $ongoing_query1 = "SELECT * from `dentalmarcelo_chat` where (`user_id`=:user_id and `from_user`=0) or (`from_user`=:from_user and `user_id`=0) order by id";
    ...
    if($num_rows > 0)
    {
        ...
        $i=0;
         foreach($results as $result)
        {
          $ongoing_query1 = "SELECT * from dentalmarcelo_user where id=:user_id";
 ...
 if($num_token > 0)
  ...
  $ongoing_query = "SELECT * from dentalmarcelo_checkin_status where appointment_id=:appointment_id order by id";
  ...
  $ongoing_query = "SELECT * from dentalmarcelo_question where cat_id=2 order by id";
  ...
  $ongoing_query = "SELECT * from dentalmarcelo_question where cat_id=1 order by id";
...
$ongoing_query = "SELECT * from dentalmarcelo_user where id=:user_id and token=:token";
 ...
 if($num_token > 0)
    {
      $parent['token']='yes';
  $ongoing_query = "SELECT * from dentalmarcelo_appointment_type";
 ...
 if($num_token > 0)
    {
    $parent['token']='yes';
     $ongoing_query = "SELECT * from dentalmarcelo_insurance_provider order by id desc";
    ...
    if($num_rows > 0)
    {
        ...
        $i=0;
         foreach($results as $result)
        {
          $ongoing_query1 = "SELECT * from dentalmarcelo_category where id=:id";
 ...
 if($num_token > 0)
    {
    $parent['token']='yes';
     $ongoing_query = "SELECT * from dentalmarcelo_offer order by id desc";
...
$parent['token']='yes';
     ...
     $ongoing_query = "SELECT * from dentalmarcelo_provider order by id desc";
  ...
  else
  {
    $parent['token']='no';
     ...
     $ongoing_query = "SELECT * from dentalmarcelo_provider where page='1' order by id desc";
 ...
 else if($event_encoded['actiontype'] == "login")
{
   ...
   $sel_user_query1 = "SELECT * FROM dentalmarcelo_user WHERE username = :username AND password=:password";
    ...
    if($num_rows>0){
      ...
      $sel_user_query12 = "Update  dentalmarcelo_user set token=:token WHERE id = :user_id";
       ...
       $sel_user_query2 = "SELECT * FROM dentalmarcelo_user_device WHERE device_id = :device_id";
    ...
    $num_rows2=$statement2->rowCount();     
        ...
        $sel_user_query12 = "Update  dentalmarcelo_user_device set user_id=:user_id,device_type=:device_type WHERE device_id = :device_id";
        ...
        $statement12->execute(array(
          ...
          {
                 $sel_user_query12 = "Insert into  dentalmarcelo_user_device set user_id=:user_id,device_id=:device_id,device_type=:device_type";
...
else if($event_encoded["actiontype"] == "signup")
{
  ...
  $username = $event_encoded["username"];
       ...
       if($email!='')
       {
        $ongoing_query = "SELECT * FROM `dentalmarcelo_user` where email=:email";
      ...
      else
      {
        $num_rows=0;
         ...
         $ongoing_query1 = "SELECT * FROM `dentalmarcelo_user` where username=:username";
        ...
        if($num_rows==0 && $num_rows1==0){
          ...
          $ongoing_query = "Insert into `dentalmarcelo_user` set `fullname`=:fullname,`email`=:email,username=:username,password=:password,phone=:phone,total_coverage='',profile_pic='',registration_date=:dt";
