...
<?php
$ongoing_query = "SELECT * from dentalmarcelo_appointment where status='In Progress' or status='approved'";
       ...
       $statement = $pdo->prepare($ongoing_query);
        ...
        $ongoing_query = "SELECT * from dentalmarcelo_appointment where status='completed'";
       ...
       $statement = $pdo->prepare($ongoing_query);
        ...
        $statement->execute(array(
         ...
         $num_rows1=$statement->rowCount();
          ...
          $ongoing_query = "SELECT * from dentalmarcelo_review";
...
<!--<li><a href="<?php SITE_ADMIN_URL ?>assign_location.php" target="_parent" title="Doctors"><span class="doc"></span>Assigns Doctors</a></li>-->
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="whiteBox">
            ...
            <ul class="patinet">
                <?php
                    $query_device = "select * from `dentalmarcelo_appointment` where status='approved' order by id desc";
