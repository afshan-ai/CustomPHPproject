...
if(isset($_REQUEST['sub']))
{
        ...
        $ongoing_query = "Update `dentalmarcelo_dentalxchange` set description=:description where id=:id";
...
$query_device = "select * from `dentalmarcelo_dentalxchange` where id=:id";
