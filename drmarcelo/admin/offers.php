...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="tableshow">
  <tr class="raw">
    ...
    <td align="left" valign="top"><strong>Title</strong> </td>
        <td align="left" valign="top"><strong>Offer Code</strong> </td>
 ...
 <?php
  $query_device = "select * from `dentalmarcelo_offer` order by id desc";
...
<tr>
  ...
  <td align="left" valign="top" ><?php echo $cat->title; ?></td>
   <td align="left" valign="top" ><?php echo $cat->code; ?></td>
    <td align="left" valign="top" ><?php echo $cat->description; ?></td>
    <td align="left" valign="top">
      <span class="edit"><a href="edit_offer.php?id=<?php echo $cat->id; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> </span>
      <span class="delete"><a href="offers.php?id=<?php echo $cat->id; ?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a> </span>
     </td>
</tr>
<?php 
}
...
{
  $ongoing_query1 = "Delete from dentalmarcelo_offer where id=:id";
