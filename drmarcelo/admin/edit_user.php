...
if(isset($_REQUEST['sub']))
{
        ...
        $ongoing_query = "update `dentalmarcelo_user` set `fullname`=:fullname,email=:email,phone=:phone,total_coverage=:total_coverage where id=:id";
...
?>
<?php
 $query_device = "select * from `dentalmarcelo_user` where id=:id order by id desc";
