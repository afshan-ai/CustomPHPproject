...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="tableshow">
 ...
 {
    $query_device = "select * from `dentalmarcelo_user` where fullname like :search order by id desc";
 ...
 {
 $query_device = "select * from `dentalmarcelo_user` order by id desc";
    ...
    foreach($result_devices as $cat)
    {
      ...
      $ongoing_query1 = "SELECT * from dentalmarcelo_user where id=:id";
      ...
      $ongoing_query1 = "SELECT * from dentalmarcelo_provider where id=:id";
        ...
        $result2 = $statement1->fetch();
          ...
          $ongoing_query1 = "SELECT * from dentalmarcelo_appointment_type where id=:id";
 ...
 $ongoing_query1 = "SELECT * from dentalmarcelo_appointment where user_id=:id order by id desc";
...
{
  $ongoing_query1 = "Delete from dentalmarcelo_user where id=:id";
