...
<td align="left" valign="top"><strong>Status</strong></td>
 ...
 $query_device = "select * from `dentalmarcelo_appointment` order by id desc";
    ...
    foreach($result_devices as $cat)
    {
      ...
      $ongoing_query1 = "SELECT * from dentalmarcelo_provider where id=:id";
        ...
        $result3 = $statement1->fetch();
         ...
         $ongoing_query1 = "SELECT * from dentalmarcelo_checkin_status where appointment_id=:id";
...
{
  $ongoing_query1 = "Delete from dentalmarcelo_appointment where id=:id";
