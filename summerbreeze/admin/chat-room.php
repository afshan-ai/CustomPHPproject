...
<div class="chatRoom">
                    ...
                    <div class="card conversation">
                        <div class="chat">
                            <div class="chat-header clearfix">
                                <?php 
                                $query_device = "select * from `dentalsb_user` where id=:user_id order by id desc";
    ...
    $query_device = "select * from `dentalsb_appointment`  where user_id=:user_id order by id desc";
