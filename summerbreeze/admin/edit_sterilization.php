...
if(isset($_REQUEST['sub']))
{
        ...
        $ongoing_query = "Update `dental2_sterilization` set `title`=:title,description=:description where id=:id";
...
$query_device = "select * from `dental2_sterilization` where id=:id";
