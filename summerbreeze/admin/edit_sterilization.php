...
if(isset($_REQUEST['sub']))
{
        ...
        $ongoing_query = "Update `dentalsb_sterilization` set `title`=:title,description=:description where id=:id";
...
$query_device = "select * from `dentalsb_sterilization` where id=:id";
