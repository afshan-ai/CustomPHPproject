...
$pdf->AddPage();
$query_device = "select * from `dental2_patient_acknowledge_form` where user_id=:user_id";
...
<p>I confirm that I do NOT have any TWO OR MORE or the following symptoms of COVID-19: fever, new or worsening cough, sore throat, runny nose or headache. <table><tr><th>'.$result->question8.'</th></tr></table></p>

<p>I confirm that I have not tested positive for COVID-19. <table><tr><th>'.$result->question9.'</th></tr></table></p>

<p>I confirm that I am not waiting for the results of a test for COVID-19. <table><tr><th>'.$result->question10.'</th></tr></table></p>

<p>I  confirm  that  this  is  not  currently  a  period  where  I  required  to  self-isolate  for  14  days. <table><tr><th>'.$result->question11.'</th></tr></table></p>
