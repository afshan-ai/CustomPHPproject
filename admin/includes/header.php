...
<title>Summer Breeze Dental ::ADMIN</title>
...
<nav>
               <select name="select" id="select" ONCHANGE="location = this.options[this.selectedIndex].value;">
                 ...
                 <option value="appointment.php">Manage schedule</option>
...
?>
                    ...
                    <li  <?php if ($link == 'appointment.php') { ?> class="selected" <?php 
                                                                                    } ?>><span><a href="appointment.php" class="manageschedule-icon">Manage schedule</a></span></li>  
                                                                                    <li  <?php if ($link == 'provider.php') { ?> class="selected" <?php 
                                                                                    } ?>><span><a href="provider.php" class="manageschedule-icon">Provider List</a></span></li>            
                    <li <?php if ($link == 'list_users.php') { ?> class="selected" <?php 
                                                                                } ?>><span><a href="list_users.php" class="user-icon">List of Users</a></span></li>            
...
<div class="hd_rt">
    <div class="row">
        <div class="col-md-12 col-sm-12">
             <div class="search"><form><i class="fa fa-search"></i><input type="search" placeholder="Search for patients" class="form-control"></form></div>
                ...
                <div class="hd_rt_right">
                    ...
                    <p class="ping"><a href=""><img src="./images/maill.png" alt=""><!--<span class="count">8</span>--></a></p>
                </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <h2 class="heading">Welcome to Summer Breeze Dental</h2>
        </div>
