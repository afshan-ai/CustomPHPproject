...
if(isset($_REQUEST['sub']))
{
	...
	$ongoing_query = "Insert into `dental_provider` set `title`=:title,bio=:bio,cat_id=:cat_id,page=:page,image=:image";
...
<textarea name="bio"></textarea> 
  ...
  <p><label><span>*</span>Designation :</label>
  	<select name="cat_id">
  	<?php
  	 $query_device = "select * from `dental_category`";
...
<p class="radioSet"><label><span>*</span>Show on Home Page :</label>
  <input type="radio" name="page" value=1 /> Yes 
