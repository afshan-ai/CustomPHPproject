...
include "config.php";
$site = 'http://developer.marketingplatform.ca/dentalapp/forgreatteeth/admin/';
$site1 = 'http://developer.marketingplatform.ca/dentalapp/forgreatteeth/image/';
...
{
     $sel_user_query1 = "SELECT * FROM dental3_user WHERE id = :id AND password=:password";
    ...
    if($num_rows>0){
      ...
      $sel_user_query1 = "Update dental3_user set password=:password WHERE id = :id";
     ...
     $ongoing_query = "SELECT * from dental3_offer order by id desc";
  ...
  $ongoing_query = "SELECT * from dental3_notification where notification_type=:notification_type";
...
"notification_type"=>$event_encoded["notification_type"]
    ...
    $ongoing_query = "Update `dental3_user` set `profile_pic`=:profile_pic,`total_coverage`=:total_coverage,`phone`=:phone,`fullname`=:fullname where  `id`=:id";
  ...
  $ongoing_query = "SELECT * from dental3_review where provider_id=:provider_id and approve=1 order by id desc";
    ...
    if($num_rows > 0)
    {
      ...
      $ongoing_query1 = "SELECT avg(`rating`) as `rating` from dental3_review where  provider_id=:provider_id and approve=1";
...
$ongoing_query1 = "SELECT * from dental3_review where  provider_id=:provider_id and rating>1 and rating<2 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dental3_review where  provider_id=:provider_id and rating>2 and rating<3 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dental3_review where  provider_id=:provider_id and rating>3 and rating<4 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dental3_review where  provider_id=:provider_id and rating>4 and rating<5 and approve=1";
        ...
        $ongoing_query1 = "SELECT * from dental3_review where  provider_id=:provider_id and rating=5 and approve=1";
         ...
         foreach($results as $result)
        {
          ...
          $ongoing_query1 = "SELECT * from dental3_user where  id=:id order by id";
	...
	$ongoing_query = "SELECT * from dental3_review where provider_id=:provider_id and user_id=:user_id";
    ...
    {
	  $ongoing_query = "Insert into `dental3_review` set `provider_id`=:provider_id,`rating`=:rating,review=:review,user_id=:user_id";
   ...
   $parent['status'] = "yes";
    ...
    $ongoing_query = "Insert into `dental3_referral` set `email`=:email,`message`=:message,name=:name,user_id=:user_id";
...
$meal['name'] = $event_encoded["name"];
   ...
   $parent['status'] = "yes";
	...
	$answer = implode(',',json_decode($event_encoded["answer_id"]));
	  $ongoing_query = "Insert into `dental3_questionnaire` set `cat_id`=:cat_id,`question_id`=:question_id,answer=:answer,user_id=:user_id";
   ...
   $parent['status'] = "yes";
    ...
    $ongoing_query = "Insert into `dental3_patient_acknowledge_form` set user_id=:user_id,question1=:question1,question2=:question2,question3=:question3,question4=:question4,question5=:question5,question6=:question6,question7=:question7,question8=:question8,question9=:question9,question10=:question10,question11=:question11";
...
mail($to,$subject,$body,$headers);*/
        ...
        $parent['status'] = "yes";
              ...
              $ongoing_query = "Insert into `dental3_checkin_status` set `appointment_id`=:appointment_id,`checkin_status`=:checkin_status,checkin_note=:checkin_note";
        ...
        $parent['status'] = "yes";
              ...
              $ongoing_query = "Insert into `dental3_appointment` set `appointment_type`=:appointment_type,`provider_id`=:provider_id,note=:note,appointment_time=:appointment_time,appointment_date=:appointment_date,status='In Progress',user_id=:user_id,appointment=:appointment,scheduled_time=:scheduled_time,new_user=:new_user,office=:office";
    ...
    $ongoing_query = "Insert into `dental3_chat` set `message`=:message,user_id=0,dt=:dt,from_user=:user_id";
...
$ongoing_query = "SELECT * from dental3_insurance where  user_id=:user_id";
       ...
       $statement = $pdo->prepare($ongoing_query);
        ...
        $statement->execute(array( "user_id" =>$event_encoded['user_id']
         ...
         if($num_rows>0)
         {
              ...
              $ongoing_query = "Update `dental3_insurance` set `insurance_id`=:insurance_id,`dental_amount`=:dental_amount,vision_amount=:vision_amount,total_coverage=:total_coverage where user_id=:user_id";
        ...
        $statement->execute(array(
            ...
            {
               $ongoing_query = "Insert into `dental3_insurance` set `insurance_id`=:insurance_id,`dental_amount`=:dental_amount,vision_amount=:vision_amount,user_id=:user_id,total_coverage=:total_coverage";
  ...
  $ongoing_query = "SELECT * from dental3_notification where user_id=:user_id order by id desc";
  ...
  $ongoing_query = "SELECT * from dental3_gallery order by id desc";
...
{
  $ongoing_query = "SELECT * from dental3_appointment where (status='approved' or status='In Progress') and user_id=:user_id order by id";
}
if($event_encoded["type"]=='cancelled')
{
  $ongoing_query = "SELECT * from dental3_appointment where status='cancelled' and user_id=:user_id order by id";
}
if($event_encoded["type"]=='completed')
{
  $ongoing_query = "SELECT * from dental3_appointment where status='completed' and user_id=:user_id order by id";
}
    ...
    if($num_rows > 0)
    {
        ...
        $i=0;
         foreach($results as $result)
        {
          $ongoing_query1 = "SELECT * from dental3_provider where  id=:id order by id";
  ...
  $ongoing_query = "SELECT * from dental3_insurance where user_id=:user_id order by id";
    ...
    if($num_rows > 0)
    {
        ...
        $i=0;
         foreach($results as $result)
        {
           /*$ongoing_query1 = "SELECT * from dental3_insurance_provider where  id=:id order by id";
  ...
  $ongoing_query = "SELECT * from dental3_checkin_status where appointment_id=:appointment_id order by id";
  ...
  $ongoing_query = "SELECT * from dental3_question where cat_id=2 order by id";
  ...
  $ongoing_query = "SELECT * from dental3_question where cat_id=1 order by id";
  ...
  $ongoing_query = "SELECT * from dental3_appointment_type";
    ...
    else
    {
     ...
     $ongoing_query = "SELECT * from dental3_insurance_provider order by id desc";
    ...
    else
    {
     ...
     $ongoing_query = "SELECT * from dental3_provider order by id desc";
    ...
    else
    {
     ...
     $ongoing_query = "SELECT * from dental3_provider where page='1' order by id desc";
 ...
 else if($event_encoded['actiontype'] == "login")
{
   ...
   $sel_user_query1 = "SELECT * FROM dental3_user WHERE username = :username AND password=:password";
    ...
    if($num_rows>0){
       ...
       $sel_user_query2 = "SELECT * FROM dental3_user_device WHERE device_id = :device_id";
    ...
    $num_rows2=$statement2->rowCount();     
        ...
        $sel_user_query12 = "Update  dental3_user_device set user_id=:user_id,device_type=:device_type WHERE device_id = :device_id";
        ...
        $statement12->execute(array(
          ...
          {
                 $sel_user_query12 = "Insert into  dental3_user_device set user_id=:user_id,device_id=:device_id,device_type=:device_type";
  ...
  $username = $event_encoded["username"];
    /*if (!preg_match("/\\s/", $email))
     {*/
       if($email!='')
       {
        $ongoing_query = "SELECT * FROM `dental3_user` where email=:email";
      ...
      else
      {
        $num_rows=0;
         ...
         $ongoing_query1 = "SELECT * FROM `dental3_user` where username=:username";
        ...
        if($num_rows==0 && $num_rows1==0){
            ...
            $ongoing_query = "Insert into `dental3_user` set `fullname`=:fullname,`email`=:email,username=:username,password=:password,phone=:phone,total_coverage='',profile_pic='',registration_date=:dt";
