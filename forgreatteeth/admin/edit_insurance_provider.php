...
if(isset($_REQUEST['sub']))
{
	...
	$ongoing_query = "update `dentalfor_insurance_provider` set `title`=:title,description=:description where id=:id";
...
?>
<?php
 $query_device = "select * from `dentalfor_insurance_provider` where id=:id";
