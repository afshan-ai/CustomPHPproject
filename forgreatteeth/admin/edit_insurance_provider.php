...
if(isset($_REQUEST['sub']))
{
	...
	$ongoing_query = "update `dental3_insurance_provider` set `title`=:title,description=:description where id=:id";
...
?>
<?php
 $query_device = "select * from `dental3_insurance_provider` where id=:id";
