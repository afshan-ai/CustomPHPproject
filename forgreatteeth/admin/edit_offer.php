...
if(isset($_REQUEST['sub']))
{
        ...
        $ongoing_query = "Update `dentalfor_offer` set `title`=:title,code=:code,description=:description where id=:id";
...
$query_device = "select * from `dentalfor_offer` where id=:id";
