...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="tableshow">
 ...
 {
    $query_device = "select * from `dental3_user` where fullname like :search order by id desc";
 ...
 $ongoing_query1 = "SELECT * from dental3_appointment where user_id=:id order by id desc";
...
{
  $ongoing_query1 = "Delete from dental3_user where id=:id";
