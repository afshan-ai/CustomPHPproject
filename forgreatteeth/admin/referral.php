...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="tableshow">
 ...
 <?php
  $query_device = "select * from `dental3_referral` order by id desc";
    ...
    foreach($result_devices as $cat)
    {
      ...
      $query_device = "select * from `dental3_user` where id=:id";
...
{
  $ongoing_query1 = "Delete from dental3_referral where id=:id";
