...
if(isset($_REQUEST['sub']))
{
        ...
        $ongoing_query = "Update `dental1_sterilization` set `title`=:title,description=:description where id=:id";
...
$query_device = "select * from `dental1_sterilization` where id=:id";
