...
if(isset($_REQUEST['sub']))
{
        ...
        $ongoing_query = "update `dental1_location` set `location`=:location,address=:address,city=:city,state=:state,zip=:zip where id=:id";
...
?>
<?php
 $query_device = "select * from `dental1_location` where id=:id order by id desc";
