...
if(isset($_REQUEST['sub']))
{
  //echo '<pre>';print_r($_REQUEST);echo '</pre>';
		$ongoing_query ="Update `dental1_appointment` set `scheduled_time`=:appointment_time,appointment_date=:appointment_date,new_user=:new_user,status=:status where id=:id";
...
$query_device = "select * from `dental1_user_device` where user_id=:user_id";
...
"notification_type"=>"Appointment"
 ...
 $query_device = "select * from `dental1_appointment` where id=:id";
