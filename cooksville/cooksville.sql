...
-- Generation Time: Jul 17, 2020 at 01:46 AM
...
--
-- Table structure for table `dental1_admin`
--

CREATE TABLE `dental1_admin` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_admin`
--

INSERT INTO `dental1_admin` (`id`, `username`, `password`) VALUES
(1, 'admin', '940b98f37d94243ec9fca8e3c7fa7a59');

-- --------------------------------------------------------

--
-- Table structure for table `dental1_appointment`
--

CREATE TABLE `dental1_appointment` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_appointment`
--

INSERT INTO `dental1_appointment` (`id`, `appointment_type`, `provider_id`, `note`, `appointment_date`, `appointment_time`, `status`, `user_id`, `appointment`, `office`, `scheduled_time`, `new_user`) VALUES
(136, 1, 1, '', '2020-07-22', 'Before 12 P.M.(Morning)', 'approved', 53, 'In Person', 'Mississauga Office', '9.00 am', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dental1_appointment_type`
--

CREATE TABLE `dental1_appointment_type` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_appointment_type`
--

INSERT INTO `dental1_appointment_type` (`id`, `title`, `duration`) VALUES
...
--
-- Table structure for table `dental1_category`
--

CREATE TABLE `dental1_category` (
  `id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `dental1_category`
--

INSERT INTO `dental1_category` (`id`, `title`) VALUES
(1, 'Dentist'),
(2, 'Dental Hygienist'),
(3, 'Office Manager');
...
--
-- Table structure for table `dental1_chat`
--

CREATE TABLE `dental1_chat` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_chat`
--

INSERT INTO `dental1_chat` (`id`, `user_id`, `message`, `dt`, `from_user`) VALUES
...
--
-- Table structure for table `dental1_checkin_status`
--

CREATE TABLE `dental1_checkin_status` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_checkin_status`
--

INSERT INTO `dental1_checkin_status` (`id`, `appointment_id`, `checkin_status`, `checkin_note`) VALUES
...
--
-- Table structure for table `dental1_dentalxchange`
--

CREATE TABLE `dental1_dentalxchange` (
  `id` int(11) NOT NULL,
  `description` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `dental1_dentalxchange`
--

INSERT INTO `dental1_dentalxchange` (`id`, `description`) VALUES
...
--
-- Table structure for table `dental1_gallery`
--

CREATE TABLE `dental1_gallery` (
  `id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL,
...
--
-- Dumping data for table `dental1_gallery`
--

INSERT INTO `dental1_gallery` (`id`, `title`, `image`) VALUES
...
--
-- Table structure for table `dental1_history_form`
--

CREATE TABLE `dental1_history_form` (
  `id` int(11) NOT NULL,
  `appointment_id` int(11) NOT NULL,
...
--
-- Table structure for table `dental1_insurance`
--

CREATE TABLE `dental1_insurance` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_insurance`
--

INSERT INTO `dental1_insurance` (`id`, `user_id`, `insurance_id`, `dental_amount`, `vision_amount`, `total_coverage`) VALUES
...
--
-- Table structure for table `dental1_insurance_provider`
--

CREATE TABLE `dental1_insurance_provider` (
  `id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL,
  `description` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `dental1_insurance_provider`
--

INSERT INTO `dental1_insurance_provider` (`id`, `title`, `description`) VALUES
...
--
-- Table structure for table `dental1_location`
--

CREATE TABLE `dental1_location` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_location`
--

INSERT INTO `dental1_location` (`id`, `location`, `address`, `city`, `state`, `zip`) VALUES
(3, 'Mississauga', '47 Dundas St W Mississauga', 'Mississauga', 'Ontario', 'L5B 1H2');

-- --------------------------------------------------------

--
-- Table structure for table `dental1_notification`
--

CREATE TABLE `dental1_notification` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_notification`
--

INSERT INTO `dental1_notification` (`id`, `user_id`, `notification_type`, `message`, `notification_date`, `notification_attr`) VALUES
...
--
-- Table structure for table `dental1_offer`
--

CREATE TABLE `dental1_offer` (
  `id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL,
...
--
-- Dumping data for table `dental1_offer`
--

INSERT INTO `dental1_offer` (`id`, `title`, `code`, `description`) VALUES
(1, 'No Offer', 'No offer', 'Currently there are no offers.');

-- --------------------------------------------------------

--
-- Table structure for table `dental1_patient_acknowledge_form`
--

CREATE TABLE `dental1_patient_acknowledge_form` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `question1` text NOT NULL,
  `question2` text NOT NULL,
...
--
-- Dumping data for table `dental1_patient_acknowledge_form`
--

INSERT INTO `dental1_patient_acknowledge_form` (`id`, `user_id`, `question1`, `question2`, `question3`, `question4`, `question5`, `question6`, `question7`, `question8`, `question9`, `question10`, `question11`) VALUES
...
--
-- Table structure for table `dental1_patient_screening_form`
--

CREATE TABLE `dental1_patient_screening_form` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_patient_screening_form`
--

INSERT INTO `dental1_patient_screening_form` (`id`, `staff`, `name`, `age`, `email`, `phone`, `other`, `question1`, `question2`, `question3`, `answered`, `appointment_id`, `question4`, `question5`, `question6`, `question7`, `question8`) VALUES
...
--
-- Table structure for table `dental1_provider`
--

CREATE TABLE `dental1_provider` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_provider`
--

INSERT INTO `dental1_provider` (`id`, `cat_id`, `title`, `bio`, `page`, `image`) VALUES
...
--
-- Table structure for table `dental1_question`
--

CREATE TABLE `dental1_question` (
  `id` int(11) NOT NULL,
  `cat_id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_question`
--

INSERT INTO `dental1_question` (`id`, `cat_id`, `question`, `answer1`, `answer2`, `answer3`, `answer4`) VALUES
...
--
-- Table structure for table `dental1_questionnaire`
--

CREATE TABLE `dental1_questionnaire` (
  `id` int(11) NOT NULL,
  `cat_id` int(11) NOT NULL,
...
--
-- Table structure for table `dental1_referral`
--

CREATE TABLE `dental1_referral` (
  `id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
  `email` varchar(250) NOT NULL,
  `message` text NOT NULL,
...
--
-- Dumping data for table `dental1_referral`
--

INSERT INTO `dental1_referral` (`id`, `name`, `email`, `message`, `user_id`) VALUES
(4, 'Julie Mathew', 'julie@gmail.com', 'I am reffering you', 24),
(5, 'Jack', 'jack@gmail.com', 'Please install it', 24),
(6, 'John', 'john@gmail.com', 'good', 48),
(7, 'hu', 'hu@gmail.com', 'drr', 53);

-- --------------------------------------------------------

--
-- Table structure for table `dental1_review`
--

CREATE TABLE `dental1_review` (
  `provider_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_review`
--

INSERT INTO `dental1_review` (`provider_id`, `user_id`, `review`, `rating`, `id`, `approve`) VALUES
(1, 42, 'Friendly office staff and Dr.Gamo does amazing work. My wife came here after 30 years of not going to the dentist and she had a wonderful experience. ', '5', 12, 1),
(1, 43, 'Amazing dentists and staff! Very friendly and warm.', '5', 13, 1),
(1, 44, 'I am a patient of this dental office. All the staff and associate  dentists are really nice and very gentle, especially Dr. Carmelita. They explain what they do and are very considerate with my dental needs. I really love coming back for my dental appointments.', '5', 14, 1),
(1, 48, 'Great', '5', 15, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dental1_sterilization`
--

CREATE TABLE `dental1_sterilization` (
  `id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL,
  `description` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `dental1_sterilization`
--

INSERT INTO `dental1_sterilization` (`id`, `title`, `description`) VALUES
...
--
-- Table structure for table `dental1_user`
--

CREATE TABLE `dental1_user` (
  `id` int(11) NOT NULL,
  `username` varchar(250) NOT NULL,
  `email` varchar(250) NOT NULL,
  `password` varchar(250) NOT NULL,
...
--
-- Dumping data for table `dental1_user`
--

INSERT INTO `dental1_user` (`id`, `username`, `email`, `password`, `fullname`, `phone`, `total_coverage`, `profile_pic`, `registration_date`, `token`) VALUES
(53, 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptdG9t', 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptdG9tQGdtYWlsLmNvbQ==', 'a3c4ff9c947cd287eeaa43c50272e4a6', 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptdG9t', 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptMTIzNDU2', '', '15949222326099.jpg', '2020-07-16', '159492273753'),
(54, 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptbWlrZTE=', 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptbWlrZTFAbWFpbC5jb20=', 'afcb28d65ecfe94819c7f7016f9df492', 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptbWlrZTE=', 'OUA0YjJta04kXilNKkh6Y15pKEBzcGptMzk0NzQ3NDc=', '', '', '2020-07-16', '159492163154');

-- --------------------------------------------------------

--
-- Table structure for table `dental1_user_answer`
--

CREATE TABLE `dental1_user_answer` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Table structure for table `dental1_user_device`
--

CREATE TABLE `dental1_user_device` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `dental1_user_device`
--

INSERT INTO `dental1_user_device` (`id`, `user_id`, `device_id`, `device_type`) VALUES
...
(35, 48, 'ds5UNvRVfrg:APA91bFaJYJDAX442XIwYRSNRraYgFaFat24U3HF4hn3pshe33adstmE68Y3r2t4VRbgNKwTTI4e7782_LpCvbgU3KyIbydetqEb-CjOxyOq-sBOl5SLV3APMnQV1BHGupyZU5pfgSJ8', 'android'),
...
--
-- Indexes for table `dental1_admin`
--
ALTER TABLE `dental1_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_appointment`
--
ALTER TABLE `dental1_appointment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_appointment_type`
--
ALTER TABLE `dental1_appointment_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_category`
--
ALTER TABLE `dental1_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_chat`
--
ALTER TABLE `dental1_chat`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_checkin_status`
--
ALTER TABLE `dental1_checkin_status`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_dentalxchange`
--
ALTER TABLE `dental1_dentalxchange`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_gallery`
--
ALTER TABLE `dental1_gallery`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_history_form`
--
ALTER TABLE `dental1_history_form`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_insurance`
--
ALTER TABLE `dental1_insurance`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_insurance_provider`
--
ALTER TABLE `dental1_insurance_provider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_location`
--
ALTER TABLE `dental1_location`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_notification`
--
ALTER TABLE `dental1_notification`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_offer`
--
ALTER TABLE `dental1_offer`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_patient_acknowledge_form`
--
ALTER TABLE `dental1_patient_acknowledge_form`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_patient_screening_form`
--
ALTER TABLE `dental1_patient_screening_form`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_provider`
--
ALTER TABLE `dental1_provider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_question`
--
ALTER TABLE `dental1_question`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_questionnaire`
--
ALTER TABLE `dental1_questionnaire`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_referral`
--
ALTER TABLE `dental1_referral`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_review`
--
ALTER TABLE `dental1_review`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_sterilization`
--
ALTER TABLE `dental1_sterilization`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_user`
--
ALTER TABLE `dental1_user`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_user_answer`
--
ALTER TABLE `dental1_user_answer`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dental1_user_device`
--
ALTER TABLE `dental1_user_device`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dental1_admin`
--
ALTER TABLE `dental1_admin`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `dental1_appointment`
--
ALTER TABLE `dental1_appointment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT for table `dental1_appointment_type`
--
ALTER TABLE `dental1_appointment_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `dental1_category`
--
ALTER TABLE `dental1_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `dental1_chat`
--
ALTER TABLE `dental1_chat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;

--
-- AUTO_INCREMENT for table `dental1_checkin_status`
--
ALTER TABLE `dental1_checkin_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `dental1_dentalxchange`
--
ALTER TABLE `dental1_dentalxchange`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `dental1_gallery`
--
ALTER TABLE `dental1_gallery`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `dental1_history_form`
--
ALTER TABLE `dental1_history_form`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `dental1_insurance`
--
ALTER TABLE `dental1_insurance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `dental1_insurance_provider`
--
ALTER TABLE `dental1_insurance_provider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `dental1_location`
--
ALTER TABLE `dental1_location`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `dental1_notification`
--
ALTER TABLE `dental1_notification`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `dental1_offer`
--
ALTER TABLE `dental1_offer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `dental1_patient_acknowledge_form`
--
ALTER TABLE `dental1_patient_acknowledge_form`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `dental1_patient_screening_form`
--
ALTER TABLE `dental1_patient_screening_form`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `dental1_provider`
--
ALTER TABLE `dental1_provider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `dental1_question`
--
ALTER TABLE `dental1_question`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `dental1_questionnaire`
--
ALTER TABLE `dental1_questionnaire`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dental1_referral`
--
ALTER TABLE `dental1_referral`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `dental1_review`
--
ALTER TABLE `dental1_review`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `dental1_sterilization`
--
ALTER TABLE `dental1_sterilization`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `dental1_user`
--
ALTER TABLE `dental1_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `dental1_user_answer`
--
ALTER TABLE `dental1_user_answer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dental1_user_device`
--
ALTER TABLE `dental1_user_device`
